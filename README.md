...
| GitHub Copilot | Legacy `apps.json`, then the supported macOS native `copilot-cli` Keychain selection described below, then the public-host token in GitHub CLI `hosts.yml`                                                                                                                                                                                                                                                                                                                   |
