...
| `credits`                                               | `all`   | The provider reported a raw credit balance, with or without measurable scopes. `detail` states that balance verbatim; no percentage or bound is derived from it.                          |
