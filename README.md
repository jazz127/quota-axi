...
| `credits`                                               | `all`   | The provider reported a raw credit balance without measurable scopes, or a fresh positive/unlimited balance alongside windows. `detail` states that balance verbatim; no percentage or bound is derived from it. |
